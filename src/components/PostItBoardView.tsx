        ...
        <div className="fixed inset-0 z-50 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              <div className="flex items-center gap-2">
                <StickyNote className="w-5 h-5 text-[#34877c]" />
            ...
            <form onSubmit={handleSave} className="space-y-3">
                    ...
                    return (
                      <button
                        ...
                        className={`w-7 h-7 rounded-full border-2 transition-all flex items-center justify-center ${
                          ...
                          color === c
                            ? 'scale-110 ring-2 ring-offset-2 ring-[#34877c]'
              ...
              <div className="flex items-center gap-2 pt-1">
                <input
                  ...
                  className="rounded text-[#34877c] focus:ring-[#34877c]"
                />
                <label htmlFor="pinnedCheck" className="text-xs text-slate-700 dark:text-slate-300">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2 bg-[#34877c] hover:bg-[#276961] text-white rounded-xl text-xs font-semibold shadow-sm"
                  >
